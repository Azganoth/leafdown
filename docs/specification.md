...
- Double-clicking text preserves the browser's word-boundary behavior but excludes
  immediately following horizontal whitespace from the resulting selection.
