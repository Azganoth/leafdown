...
import { openMarkdownFilePath } from "../services/openMarkdownFile";
import { openFolderContextPath } from "../services/openFolderContext";
...
describe("open Markdown dirty transitions", () => {
  ...
  it("cancels open-folder transitions before scanning a new folder", async () => {
    ...
    await expect(openFolderContextPath("C:/Other")).resolves.toBe(false);
